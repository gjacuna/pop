...
This app is basically a clone of [Chat GPT](https://chat.openai.com/chat) (you will need an Open AI API Key to use it), with an option to store the whole conversation on-chain, FOREVER!
